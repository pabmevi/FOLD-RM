...
def Imput_lessnoise_allsp_rates():
    attrs = ["IUCN_name", "Country", "Frequency_month","Survey_interval_days","Road_length_km","Survey_period_days","Latitude","Longitude",
...
model.confidence_fit(data, improvement_threshold=0.7)
